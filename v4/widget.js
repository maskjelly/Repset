(function () {
  ...
  // Configuration (data-api-key removed)
  const config = {
    ...
    <div class="chat-container">
      ...
      <div class="footer">
        <small class="attribution">
          made by maskjelly aka. whiteye • <a href="https://x.com/LiquidZooo" target="_blank">Twitter</a>
        </small>
      </div>
    </div>
  `;

  // Attach styles and HTML to shadow root
  ...
  // Handle user input, send to API, and display responses
